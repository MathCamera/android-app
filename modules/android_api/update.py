...
def get_data_dir():
    ...
    return "/storage/emulated/0/Android/data/org.dcindia_.appupdater/files"
...
def current_version():
    ...
    return context.getPackageManager().getPackagewarning(context.getPackageName(), 0).versionName
    # return "1.0"
...
def receieve_install_intent(intent):
    ...
    Logger.warning("receieve_install_intent")
...
def install_intent(file_name: str):
    ...
    try:
        ...
        inputFile = File(f"/data/data/ru.mathcamera/files/app/{file_name}")
        ...
        Logger.warning("[AppUpdater]", error)
